/* user-dict.c generated by valac 0.14.1, the Vala compiler
...
static void skk_user_dict_real_reload (SkkDict* base, GError** error) {
	...
	if (g_strcmp0 (_tmp2_, _tmp3_) != 0) {
		...
		__catch15_skk_skk_dict_error:
		{
			...
			g_warning ("user-dict.vala:133: error parsing user dictionary %s: %s", _tmp8_, _tmp10_);
			_g_free0 (_tmp8_);
			_g_error_free0 (e);
		}
		goto __finally15;
		__catch15_g_io_error:
		{
			...
			g_warning ("user-dict.vala:136: error reading user dictionary %s: %s", _tmp13_, _tmp15_);
			_g_free0 (_tmp13_);
			_g_error_free0 (e);
		}
		__finally15:
