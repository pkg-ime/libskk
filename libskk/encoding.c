/* encoding.c generated by valac 0.14.1, the Vala compiler
...
static const SkkEntry SKK_ENCODING_CONVERTER_ENCODING_TO_CODING_SYSTEM_RULE[6] = {{"UTF-8", "utf-8"}, {"EUC-JP", "euc-jp"}, {"Shift_JIS", "shift_jis"}, {"ISO-2022-JP", "iso-2022-jp"}, {"EUC-JISX0213", "euc-jisx0213"}, {"EUC-JISX0213", "euc-jis-2004"}};
		...
		for (entry_it = 0; entry_it < G_N_ELEMENTS (SKK_ENCODING_CONVERTER_ENCODING_TO_CODING_SYSTEM_RULE); entry_it = entry_it + 1) {
			...
			entry = entry_collection[entry_it];
			{
				...
				if (g_strcmp0 ((const gchar*) _tmp1_, _tmp2_) == 0) {
					...
					_tmp3_ = entry;
					_tmp4_ = _tmp3_.key;
					self = (SkkEncodingConverter*) skk_encoding_converter_construct (object_type, (const gchar*) _tmp4_, &_inner_error_);
					if (_inner_error_ != NULL) {
						g_propagate_error (error, _inner_error_);
						_g_object_unref0 (self);
						return NULL;
